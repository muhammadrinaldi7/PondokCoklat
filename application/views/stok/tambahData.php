        ...
        <div class="card-body">
            ...
            <form method="post" action="<?= base_url('bahan/Bahan/tambahDataAksi'); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_bahan" class="form-control col-md-12">
                    <?= form_error('nama_bahan','<div class="text-small text-danger"></div>') ?>
                </div>
                <div class="form-group">
                    <label for="">Satuan Bahan</label>
                    <input type="text" name="satuan" class="form-control col-md-10">  
                    <?= form_error('satuan','<div class="text-small text-danger"></div>') ?>
                </div>
                <div class="form-group">
                    <label for="">Harga bahan</label>
                    <input type="text" name="harga" class="form-control col-md-10">  
