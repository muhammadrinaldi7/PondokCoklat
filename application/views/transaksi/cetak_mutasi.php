		              ...
		              <div class="card border-left-danger shadow h-100 py-2">
		                <div class="card-body">
		                  <div class="row no-gutters align-items-center">
		                	<div class="col mr-2">
		                    	<div class="text-xl font-weight-bold text-danger text-uppercase mb-1">Cetak Mutasi Bahan</div> 
									<div class="col mb-2">
							  			<form target="_blank" action="<?= base_url('transaksi/Stoksupplier/report_mutasi') ?>" method="post">
